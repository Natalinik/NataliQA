...
@pytest.mark.ui
@pytest.mark.makeup
def test_basket_one_product_counter(makeup_main_page: MakeupMainPage):
    ...
    assert makeup_main_page.get_basket_products_counter() == "1"


@pytest.mark.ui
@pytest.mark.makeup
def test_basket_several_products_counter(makeup_main_page: MakeupMainPage):
    for i in range(2):
    ...
    assert makeup_main_page.get_basket_products_counter() == "2"
